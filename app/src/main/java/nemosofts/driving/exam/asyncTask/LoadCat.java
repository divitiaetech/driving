        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (!objJson.has(Setting.TAG_SUCCESS)) {
                    String cid = objJson.getString(Setting.TAG_CID);
                    String category_name = objJson.getString(Setting.TAG_CAT_NAME);
                    String category_image = objJson.getString(Setting.TAG_CAT_IMAGE);
