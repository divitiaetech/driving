...
public class AdManagerAdmobInter {
    static InterstitialAd interAd;
    private final Context ctx;

    public AdManagerAdmobInter(Context ctx) {
        this.ctx = ctx;
    }
    ...
    public void createAd() {
        ...
        InterstitialAd.load(ctx, Setting.interstitialAdID, adRequest, new InterstitialAdLoadCallback() {
            @Override
